        ...
        <Container className="inner-container" fluid>
          ...
          <Row className="separate-top">
            ...
            <Col lg={4} md={4} xs={12} className="second-row-col-style">
              ...
              <h3>
                Store information such as the value of the item, the location where you found it,
                the year it was made and its condition.
              </h3>
            </Col>
            <Col lg={4} md={4} xs={12} className="second-row-col-style">
              <div className="second-row-image-container">
              ...
              <h3>
                There´s no limit to the number of collections or items you can have! Create as many
                as you like!
              </h3>
            </Col>
          </Row>
          <Row>
            <Col lg={12} xs={12} className="col-style add-spacing">
              ...
              <div className="about">
                <h2>
                  Treasure Keeper was developed by Josué Rodríguez as part of the Acklen Avenue's
                  Challenge. It was developed using MERN stack with React Bootstrap and Auth0
                  authentication. The idea was #38 of the list of projects specified on the
                  guidelines.
                </h2>
              </div>
            </Col>
